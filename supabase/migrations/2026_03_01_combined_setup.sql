...
drop policy if exists "Admin permissions: admin manage" on public.admin_permissions;
...
drop policy if exists "Gigs: public read published" on public.gigs;
create policy "Gigs: public read published"
on public.gigs for select
using (status = 'published');

drop policy if exists "Gigs: admin read" on public.gigs;
create policy "Gigs: admin read"
on public.gigs for select
using (public.is_admin() and public.has_admin_permission('gigs', 'read'));

drop policy if exists "Gigs: admin write" on public.gigs;
...
drop policy if exists "Case studies: admin read" on public.case_studies;
create policy "Case studies: admin read"
on public.case_studies for select
using (public.is_admin() and public.has_admin_permission('case_studies', 'read'));

drop policy if exists "Case studies: admin write" on public.case_studies;
...
drop policy if exists "Orders: client create" on public.orders;
...
drop policy if exists "Messages: client read own" on public.messages;
